        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Sữa thông tin tài khoản quản trị: <?= $quanTri['ho_ten']; ?></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="so_dien_thoai"
                                value="<?= $quanTri['so_dien_thoai']; ?>" placeholder="Nhập họ tên">
                        ...
                        <div class="form-group">
                            ...
                            <select name="trang_thai" id="inputStatus" class="form-control custom-select">
                                ...
                                <option <?= $quanTri['trang_thai'] !==1 ? 'selected' :''?> value="2">Anactive</option>
                            </select>
                        </div>

  ...
  <div class="container mt-5">
    ...
    <form action="<?= BASE_URL_ADMIN . '?act=themsanpham' ?>" method="POST">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="mo_ta" name="mo_ta" rows="4" placeholder="Nhập mô tả"></textarea>
      </div>
      <div class="mb-3">
        <label for="gia" class="form-label">Giá</label>
        <input type="number" class="form-control" id="gia" name="gia" rows="4" placeholder="Nhập giá"></input>
      </div>
      <div class="mb-3">
        <label for="so_luong" class="form-label">Số lượng</label>
        <input type="number" class="form-control" id="so_luong" name="so_luong" rows="4"
          placeholder="Nhập số lượng"></input>
      </div>
      <div class="mb-3">
        <label for="ngay_nhap" class="form-label">Ngày nhập</label>
        <input type="date" class="form-control" id="ngay_nhap" name="ngay_nhap" rows="4"
          placeholder="Nhập số lượng"></input>
      </div>
